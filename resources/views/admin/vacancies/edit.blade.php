        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.vacancies.update', $vacancy->id) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="location" class="block mt-1 w-full" type="text" name="location" :value="old('location', $vacancy->location)" required />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="type" name="type" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">
                                <option value="Full-time" @selected(old('type', $vacancy->type) == 'Full-time')>Full-time</option>
                                <option value="Part-time" @selected(old('type', $vacancy->type) == 'Part-time')>Part-time</option>
                                <option value="Contract" @selected(old('type', $vacancy->type) == 'Contract')>Contract</option>
                            </select>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="deadline" class="block mt-1 w-full" type="date" name="deadline" :value="old('deadline', $vacancy->deadline)" required />
